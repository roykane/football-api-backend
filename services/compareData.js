...
const POPULAR_PAIRS = [
  ...
  { slugA: 'inter', slugB: 'milan', label: 'Derby della Madonnina' },
  { slugA: 'juventus', slugB: 'inter', label: "Derby d'Italia" },
  { slugA: 'juventus', slugB: 'milan', label: 'Đại chiến Serie A' },
  { slugA: 'roma', slugB: 'lazio', label: 'Derby della Capitale' },
  { slugA: 'bayern-munich', slugB: 'borussia-dortmund', label: 'Der Klassiker' },
  { slugA: 'paris-saint-germain', slugB: 'marseille', label: 'Le Classique' },
  { slugA: 'bayern-munich', slugB: 'real-madrid', label: 'Đại chiến Champions League' },
  ...
  { slugA: 'bayern-munich', slugB: 'manchester-city', label: 'Đại chiến châu Âu' },
